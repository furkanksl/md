  ...
  return (
    <div className="w-full h-full flex flex-col justify-center py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 grid-rows-2 gap-4 max-w-[1100px] mx-auto w-full h-auto md:h-[500px]">
        ...
        <div className="md:col-span-4 md:row-span-1 bg-[#738F82] rounded-[2rem] p-8 relative overflow-hidden group hover:brightness-105 transition-all">
        ...
        <div className="md:col-span-2 md:row-span-1 bg-[#44403C] rounded-[2rem] p-8 text-[#FAF9F6] relative overflow-hidden group hover:brightness-110 transition-all">
           <div className="relative z-10 h-full flex flex-col justify-between">
        ...
        <div className="md:col-span-2 md:row-span-1 bg-[#F2EFE9] rounded-[2rem] p-8 hover:bg-[#E7E5E4] transition-colors group">
        ...
        <div className="md:col-span-2 md:row-span-1 bg-white border border-[#E7E5E4] rounded-[2rem] p-8 hover:border-[#D4C5BE] transition-colors group">
             <div className="h-full flex flex-col justify-between">
        ...
        <div className="md:col-span-2 md:row-span-1 bg-white border border-[#E7E5E4] rounded-[2rem] p-8 hover:border-[#738F82] transition-colors group relative overflow-hidden">
