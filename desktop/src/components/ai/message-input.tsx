...
export const MessageInput = ({
  ...
  const totalTokens = messages.reduce(
    (acc, msg) => acc + (msg.metadata?.tokenCount || 0),
    0,
  );
  ...
  const filteredCommands =
    input.startsWith("/") && !isSlashMenuDismissed
      ...
      <div className="relative w-full">
        <AnimatePresence>
          {showSlashMenu && (
            ...
            >
              <div className="bg-popover border border-border shadow-sm rounded-lg overflow-hidden flex flex-col p-1 space-y-0.5">
                ...
                <div className="flex flex-col gap-1 mt-1">
                  <div className="flex justify-between text-xs font-medium">
                    ...
                    >
                      ...
                      {formatTokens(model?.contextWindow || 128000)}
                    </span>
                  </div>
