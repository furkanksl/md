...
export const MarkdownRenderer = ({ content, className }: MarkdownRendererProps) => {
  ...
  return (
    <div className={clsx(
        ...
        "prose-p:my-0",
        "prose-pre:my-2 prose-pre:bg-stone-100/50 dark:prose-pre:bg-stone-800/50 prose-pre:rounded-lg prose-pre:p-3 prose-pre:overflow-x-auto prose-pre:max-w-full",
